...
library(rms)
vif(basic_model)
# looking at variance inflation from variables produced by the model anything  near 10 is bad, tracking all greater than 8.
rms_vars <- c("owylis_vce_Mean", "peak_vce_Mean", "unan_vce_Mean")
```
...
removed5 <- caret_high_correlation$method$remove
