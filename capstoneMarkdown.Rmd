...
churn
```{r}
# making into a nominal value, opting for logical so it is easier to understand if customer left (TRUE) or not (FALSE)
tele_clean$churn <- factor(tele_clean$churn, levels = c(0,1), labels = c(0,1))
```
asl_flag
```{r}
tele_clean %>%
