...
# Reverse Engineered my SQL script and synced to main server

cn <- dbConnect(drv      = RMySQL::MySQL(), 
                username = "root", 
                password = "daniels11", 
                host     = "ryersoncapstonemysql.c5vlumhrtljy.us-east-1.rds.amazonaws.com", 
                port     = 3306, 
                dbname   = "capstoneryersonMYSQL")

Billing_info <- dbGetQuery(cn, "SELECT * FROM Billing;")
