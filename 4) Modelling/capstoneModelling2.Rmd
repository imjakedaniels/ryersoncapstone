...
#you may need to restart R and increase your memory limit with: options(java.parameters = "-Xmx2048m")
k=10
...
```{r}
mplot_roc(final_set$churn, final_set$holdoutpred)
```
```{r}
#install.packages("ROCR")
library(ROCR)

pred <- prediction(final_set$holdoutpred, final_set$churn) 
